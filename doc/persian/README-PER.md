...
### <div dir="rtl" align='right'>استفاده در فریم ورک های جاوااسکریپت</div>

<div dir="rtl" align='right'>
<ul>
  <li><a href="#framework-angular">انگولار</a></li> 
</ul>
</div>
...
<div dir="rtl" align='right'>
اگر کتاب خانه شما Angular میباشد، میتوانید از <a href="/example-angular">پوشه <code>انگولار نمونه</code></a> برای اطلاع از نحوه پیاده سازی کمک بگیرید.
</div>
...
### <div id="framework-angular" dir="rtl" align='right'>انگولار</div>
...
<div dir="rtl" align='right'>
<ul>
  <li>حال میتوانید از متدهای ادتریس مثل <a href="/example-angular">برنامه نمونه انگولار</a> استفاده کنید.</li>
</ul>
</div>
