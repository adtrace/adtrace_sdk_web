...
describe('GDPR forget device functionality', () => {
  ...
  it('queue forget device until sdk is initialised', () => {
    ...
    expect(Logger.default.log).toHaveBeenCalledWith('Adtrace SDK will run GDPR Forget Me request after initialisation')
    ...
    expect(Logger.default.log).toHaveBeenCalledWith('Adtrace SDK is running pending GDPR Forget Me request')
    expectRequest()
  ...
  it('runs forget request and prevents subsequent one', () => {
    ...
    expect(Logger.default.log).toHaveBeenCalledWith('Adtrace SDK is already prepared to send GDPR Forget Me request')
    expectNotRequest()
  ...
  it('prevents running forget request if sdk already disabled', () => {
    ...
    expect(Logger.default.log).toHaveBeenCalledWith('Adtrace SDK is already disabled')
