...
function expectNotRunningStatic () {
  ...
  _instance.getWebUUID()
  expect(Logger.default.log).toHaveBeenLastCalledWith('Adtrace SDK is disabled, can not get web_uuid')
  expect(ActivityState.default.getWebUUID).not.toHaveBeenCalled()

  _instance.getAttribution()
  expect(Logger.default.log).toHaveBeenLastCalledWith('Adtrace SDK is disabled, can not get attribution')
