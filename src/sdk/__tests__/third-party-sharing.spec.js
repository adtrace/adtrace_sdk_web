...
describe('Third-party sharing opt-out functionality', () => {
  ...
  it('queue third-party sharing opt-out until sdk is initialised', () => {
    ...
    expect(Logger.default.log).toHaveBeenLastCalledWith('Adtrace SDK is running pending third-party sharing opt-out request')
  ...
  it('runs third-party sharing opt-out request and prevents subsequent one', () => {
    ...
    expect(Logger.default.log).toHaveBeenLastCalledWith('Adtrace SDK already queued third-party sharing opt-out request')
