...
declare namespace Adtrace {
  ...
  interface EventParams {
    ...
    /** Optional. You can also add parameters to be transmitted with event as additional data.
     *
     * @example
     * Adtrace.trackEvent({
     *   // ... other params go here, including mandatory ones
  ...
  interface InitOptions {
    ...
    /** Optional. The data residency feature allows you to choose the country in which Adtrace will store your data. This
     * is useful if you are operating in a country with strict privacy requirements. When you set up data residency,
     * Adtrace will store your data in a data center located in the region your have chosen. */
    dataResidency?: 'EU' | 'TR' | 'US';

    /** Optional. The Adtrace SDK can use the url strategy setting to prioritise regional endpoints. */
   ...
   * @example
   * Promise.race([
   *   Adtrace.trackEvent({ eventToken: 'YOUR_EVENT_TOKEN' }),
